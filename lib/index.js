...
var PoolMaster = require('./pool_master');
var termTypes = require('./protodef').Term.TermType;
...
function main(options) {
  ...
  if (options.models != null) {
    var model, models;
    _r.models = models = options.models;
    Object.keys(models).forEach(function(key) {
      model = models[key];
      if (model.constructor !== Object) {
        throw TypeError('Model types must be an object!');
      }
      model = Arguments(model);
      model.required = true;
      model.strict = true;
      model.shouldValidate = shouldValidate;
      models[key] = model;
    });
    function shouldValidate(value) {
      return (value instanceof _r._Term) === false;
    }
  }
  return _r;
}
