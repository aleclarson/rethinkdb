...
module.exports = {
  ReqlDriverError: createType(ReqlDriverError),
  ReqlServerError: createType(ReqlServerError),
  ReqlRuntimeError: createType(ReqlRuntimeError),
  ReqlCompileError: createType(ReqlCompileError),
  ReqlClientError: createType(ReqlClientError),
};
